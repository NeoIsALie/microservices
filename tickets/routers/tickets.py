...
from tickets.schemas.ticket import TicketResponse
from tickets.services.ticket import TicketService
from tickets.utils.database import get_db
...
async def get_ticket_by_id(
    ...
    return await ticket_service.get_by_id(ticket_uid=ticket_id)
